...
#    Updated: 2021/06/07 17:11:47 by yarroubi         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
FT_EXPAND_SRC = $(FT_EXPAND_PATH)/ft_append_escape_sequence.c \
				...
				$(FT_EXPAND_PATH)/ft_expand_single_quote_construct.c \
...
SRC = $(FT_PARSER_SRC) $(FT_LEXER_SRC) $(FT_EXPAND_SRC) $(FT_ERROR_SRC) \
	  $(FT_TOKEN_SRC) $(FT_ENVP_SRC) $(FT_SCMD_SRC) $(FT_PIPELINE_SRC) \
	  $(FT_REDIRECTION_SRC) $(FT_SUPPORT_FUNCTIONS_SRC)
